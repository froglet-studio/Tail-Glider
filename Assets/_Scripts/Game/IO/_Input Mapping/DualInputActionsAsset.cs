...
//     version 1.5.1
//     from Assets/_Scripts/Game/IO/_Input Mapping/DualInputActionsAsset.inputactions
//
...
public partial class @DualInputActionsAsset: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @DualInputActionsAsset()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""DualInputActionsAsset"",
    ""maps"": [
        {
            ""name"": ""Flight"",
        ...
        },
        {
            ...
            ""id"": ""cf2319cb-45b0-4a4f-b787-6a879bd1e506"",
            ""actions"": [
                {
                    ""name"": ""Fly ship"",
                    ""type"": ""Value"",
                    ""id"": ""b9e7515c-36ab-47e7-903d-ec044132a4d6"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""219e50a4-4762-4809-bd89-3395839ef727"",
                ...
                {
                    ""name"": """",
                    ""id"": ""39b95c60-20f3-4351-aff0-f7bedcdc7781"",
    ...
    ""controlSchemes"": [
        ...
        // Controller Play
        m_ControllerPlay = asset.FindActionMap("Controller Play", throwIfNotFound: true);
        m_ControllerPlay_Flyship = m_ControllerPlay.FindAction("Fly ship", throwIfNotFound: true);
    }
    ...
    {
        private @DualInputActionsAsset m_Wrapper;
        public FlightActions(@DualInputActionsAsset wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @DualInputActionsAsset m_Wrapper;
        public TouchActions(@DualInputActionsAsset wrapper) { m_Wrapper = wrapper; }
    ...
    // Controller Play
    private readonly InputActionMap m_ControllerPlay;
    private List<IControllerPlayActions> m_ControllerPlayActionsCallbackInterfaces = new List<IControllerPlayActions>();
    private readonly InputAction m_ControllerPlay_Flyship;
    public struct ControllerPlayActions
    {
        private @DualInputActionsAsset m_Wrapper;
        public ControllerPlayActions(@DualInputActionsAsset wrapper) { m_Wrapper = wrapper; }
        public InputAction @Flyship => m_Wrapper.m_ControllerPlay_Flyship;
        public InputActionMap Get() { return m_Wrapper.m_ControllerPlay; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(ControllerPlayActions set) { return set.Get(); }
        public void AddCallbacks(IControllerPlayActions instance)
        {
            if (instance == null || m_Wrapper.m_ControllerPlayActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_ControllerPlayActionsCallbackInterfaces.Add(instance);
            @Flyship.started += instance.OnFlyship;
            @Flyship.performed += instance.OnFlyship;
            @Flyship.canceled += instance.OnFlyship;
        }

        private void UnregisterCallbacks(IControllerPlayActions instance)
        {
            @Flyship.started -= instance.OnFlyship;
            @Flyship.performed -= instance.OnFlyship;
            @Flyship.canceled -= instance.OnFlyship;
        ...
        public void RemoveCallbacks(IControllerPlayActions instance)
        {
            if (m_Wrapper.m_ControllerPlayActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IControllerPlayActions instance)
        {
            foreach (var item in m_Wrapper.m_ControllerPlayActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ControllerPlayActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public ControllerPlayActions @ControllerPlay => new ControllerPlayActions(this);
    ...
    public interface IControllerPlayActions
    {
        void OnFlyship(InputAction.CallbackContext context);
    }
}
